...
"""
================================================================================
CRYPTO BACKTESTER PRO v3.0 - MODERN MULTI-PAGE UI
Beautiful, intuitive, mobile-optimized interface
================================================================================
"""
...
# ============================================================
# INDICATORS & ENGINE (Same as before)
# ============================================================
...
def main():
    ...
    with tab2:
        ...
        with col1:
            ...
            sl_atr = st.slider("ATR Multiplier", 0.5, 5.0, 2.0, 0.5, key="sl")
            st.markdown("</div>", unsafe_allow_html=True)

            st.markdown("<div class='glass-card'>", unsafe_allow_html=True)
            st.markdown("**Take Profit**")
            tp_atr = st.slider("ATR Multiplier", 1.0, 10.0, 3.0, 0.5, key="tp")
            st.markdown("</div>", unsafe_allow_html=True)
    ...
    st.markdown("""
    <div class="footer">
        Crypto Backtester Pro v3.0 | Built with Streamlit | Mobile Optimized
    </div>
    """, unsafe_allow_html=True)
